...
JackFruitEngine::kpINI::kpINI(void)													// Default constructor
{
}

JackFruitEngine::kpINI::~kpINI(void)
{
}
...
bool JackFruitEngine::kpINI::Load(string FileName, vector<Record>& content)
{
...
bool JackFruitEngine::kpINI::Save(string FileName, vector<Record>& content)
{
...
string JackFruitEngine::kpINI::Content(string FileName)
{
...
vector<string> JackFruitEngine::kpINI::GetSectionNames(string FileName)
{
...
vector<JackFruitEngine::kpINI::Record> JackFruitEngine::kpINI::GetSection(string SectionName, string FileName)
{
...
bool JackFruitEngine::kpINI::RecordExists(string KeyName, string SectionName, string FileName)
{
	vector<Record> content;													// Holds the current record													// Holds the current record
	...
	if (Load(FileName, content))											// Make sure the file is loaded
	{
		vector<Record>::iterator iter = std::find_if(content.begin(), 
				content.end(), 
				kpINI::RecordSectionKeyIs(SectionName,KeyName));			// Locate the Section/Key
...
bool JackFruitEngine::kpINI::SectionExists(string SectionName, string FileName)
{
	vector<Record> content;													// Holds the current record													// Holds the current record
	...
	if (Load(FileName, content))											// Make sure the file is loaded
	{
		vector<Record>::iterator iter = std::find_if(content.begin(), 
				content.end(), 
				kpINI::RecordSectionIs(SectionName));					// Locate the Section
...
vector<JackFruitEngine::kpINI::Record> JackFruitEngine::kpINI::GetRecord(string KeyName, string SectionName, string FileName)
{
	vector<Record> data;													// Holds the return data
	vector<Record> content;													// Holds the current record													// Holds the current record
	...
	if (Load(FileName, content))											// Make sure the file is loaded
	{
		vector<Record>::iterator iter = std::find_if(content.begin(), 
				content.end(), 
				kpINI::RecordSectionKeyIs(SectionName,KeyName));			// Locate the Record
...
string JackFruitEngine::kpINI::GetValue(string KeyName, string SectionName, string FileName)
{
...
bool JackFruitEngine::kpINI::SetValue(string KeyName, string Value, string SectionName, string FileName)
{
	vector<Record> content;													// Holds the current record													// Holds the current record
...
bool JackFruitEngine::kpINI::RenameSection(string OldSectionName, string NewSectionName, string FileName)
{
	vector<Record> content;													// Holds the current record													// Holds the current record
...
bool JackFruitEngine::kpINI::CommentRecord(CommentChar cc, string KeyName,string SectionName,string FileName)
{
	vector<Record> content;													// Holds the current record													// Holds the current record
...
bool JackFruitEngine::kpINI::UnCommentRecord(string KeyName,string SectionName,string FileName)
{
	vector<Record> content;													// Holds the current record													// Holds the current record
...
bool JackFruitEngine::kpINI::CommentSection(char CommentChar, string SectionName, string FileName)
{
	vector<Record> content;													// Holds the current record													// Holds the current record
...
bool JackFruitEngine::kpINI::UnCommentSection(string SectionName, string FileName)
{
	vector<Record> content;													// Holds the current record													// Holds the current record
...
bool JackFruitEngine::kpINI::DeleteRecord(string KeyName, string SectionName, string FileName)
{
	vector<Record> content;													// Holds the current record													// Holds the current record
...
bool JackFruitEngine::kpINI::DeleteSection(string SectionName, string FileName)
{
	vector<Record> content;													// Holds the current record													// Holds the current record
...
bool JackFruitEngine::kpINI::SetSectionComments(string Comments, string SectionName, string FileName)
{
	vector<Record> content;													// Holds the current record													// Holds the current record
...
bool JackFruitEngine::kpINI::SetRecordComments(string Comments, string KeyName, string SectionName, string FileName)
{
	vector<Record> content;													// Holds the current record													// Holds the current record
...
vector<JackFruitEngine::kpINI::Record> JackFruitEngine::kpINI::GetSections(string FileName)
{
	vector<Record> data;													// Holds the return data
	vector<Record> content;													// Holds the current record													// Holds the current record
...
bool JackFruitEngine::kpINI::Sort(string FileName, bool Descending)
{
	vector<kpINI::Record> content;										// Used to hold the sorted content
	vector<kpINI::Record> sections = GetSections(FileName);				// Get a list of Sections
	...
	if(!sections.empty())													// Is there anything to process?
	{
		...
		{																		
			...
			vector<kpINI::Record> records = GetSection(iter->Section ,FileName); // Get a list of Records for this section
...
bool JackFruitEngine::kpINI::AddSection(string SectionName, string FileName)
{
	vector<Record> content;													// Holds the current record													// Holds the current record
...
bool JackFruitEngine::kpINI::Create(string FileName)
{
