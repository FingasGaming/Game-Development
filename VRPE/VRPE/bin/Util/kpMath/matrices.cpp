...
JackFruitEngine::kpMatrices::kpMatrices()
{
...
void JackFruitEngine::kpMatrices::loadIdentity()
{
...
void JackFruitEngine::kpMatrices::matrixMode(int i)
{
	if(i==MODEL_MATRIX)
		currentMatrix=MODEL_MATRIX;
...
void JackFruitEngine::kpMatrices::translate(float x,float y,float z)
{
...
void JackFruitEngine::kpMatrices::scale(float x,float y,float z)
{
	if(currentMatrix==MODEL_MATRIX)
...
void JackFruitEngine::kpMatrices::scale(float x)
{
	if(currentMatrix==MODEL_MATRIX)
...
void JackFruitEngine::kpMatrices::rotateX(float angle)
{
	if(currentMatrix==MODEL_MATRIX)
...
void JackFruitEngine::kpMatrices::rotateY(float angle)
{
	if(currentMatrix==MODEL_MATRIX)
...
void JackFruitEngine::kpMatrices::rotateZ(float angle)
{
	if(currentMatrix==MODEL_MATRIX)
	...
	matricesReady=false;	
		...
		//projection
void JackFruitEngine::kpMatrices::perspective(float angle,float aRatio,float near,float far)
{
	projectionMatrix[projectionMatrix.size()-1]=glm::perspective(angle,aRatio,near,far);
	matricesReady=false;
}

void JackFruitEngine::kpMatrices::ortho(float left,float right,float bottom,float top,float near,float far)
{
	projectionMatrix[projectionMatrix.size()-1]=glm::ortho(left,right,bottom,top,near,far);
	matricesReady=false;
}
		
void JackFruitEngine::kpMatrices::pushMatrix()
{
	glm::mat4 matrix;
	if(currentMatrix==MODEL_MATRIX)
	{
...
void JackFruitEngine::kpMatrices::popMatrix()
{
	if(currentMatrix==MODEL_MATRIX)
	{
...
glm::mat4& JackFruitEngine::kpMatrices::getModelMatrix()
{
	return modelMatrix[modelMatrix.size()-1];
}

glm::mat4& JackFruitEngine::kpMatrices::getModelViewMatrix()
{
...
glm::mat4& JackFruitEngine::kpMatrices::getModelViewProjectionMatrix()
{
	if(!matricesReady)
...
glm::mat4& JackFruitEngine::kpMatrices::getProjectionMatrix()
{
	return projectionMatrix[projectionMatrix.size()-1];
}

glm::mat3& JackFruitEngine::kpMatrices::getNormalMatrix()
{
	if(!matricesReady)
...
//GLSL
void JackFruitEngine::kpMatrices::updateMatrices(unsigned int programId)
{
	if(1)
	{
		//calculate matrices
